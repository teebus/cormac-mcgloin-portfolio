  ...
  return (
    <Layout>
      <div ref={el => (page = el)}>
        ...
        {/* {project._rawProjectContent &&
          project._rawProjectContent.map(project => {
            if (project._type === "image") {
              return (
                <Controller key={project._key}>
                  <Scene
        ...
        {/* </div>
              ...
              return (
                <div id="hello">
                  {project.children.map(child => child.text).join("")}
                </div>
              )
            }
          })} */}
