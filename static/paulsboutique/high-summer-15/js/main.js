...
var scene = new ScrollMagic.Scene({triggerElement: '#trigger-2', offset: 0})
.setTween(hattie)
.addTo(controller);
...
var scene = new ScrollMagic.Scene({triggerElement: '#trigger-3'})
.setTween(bailey)
.addTo(controller);
...
var scene = new ScrollMagic.Scene({triggerElement: '#trigger-5'})
.setTween(lilly)
.addTo(controller);
