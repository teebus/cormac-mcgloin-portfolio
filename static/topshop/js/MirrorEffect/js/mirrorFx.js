	...
	MirrorFx.prototype._initTilt = function() {
		...
		this.mousemoveFn = function(ev) {
			requestAnimationFrame(function() {
				...
				self.imgs.side1.style.WebkitTransform = self.imgs.side1.style.transform = self.imgs.side2.style.WebkitTransform = self.imgs.side2.style.transform = 'translate' + (self.options.layout === 'horizontal' ? 'X' : 'Y') + '(' + (1-tVal)*300 + '%) rotateZ(' + rz + 'deg)';
			});
		};
